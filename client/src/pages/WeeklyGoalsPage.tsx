        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_280px]">
          <div className="space-y-8">
            <div className="flex flex-wrap items-center justify-center gap-4 sm:justify-between">
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={() => shiftWeek(-1)}
                  className="rounded-xl border border-border bg-surface p-2 text-text-muted transition hover:bg-surface2 hover:text-text-primary"
            ...
            <div>
                ...
                <ul className="space-y-2">
                  {goals.map((g) => (
                    <li
                      key={g.id}
                      className={[
                        'flex items-center gap-3 rounded-2xl border border-border bg-surface p-4 transition border-l-4 shadow-card',
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2 rounded-2xl border border-dashed border-border bg-surface/50 px-3 py-2">
                ...
                <input
                  ...
                  className="min-w-[12rem] flex-1 rounded-xl border-0 bg-transparent px-3 py-2 text-sm text-text-primary outline-none placeholder:text-text-muted/70"
                  disabled={adding}
                />
                <button
                  type="button"
