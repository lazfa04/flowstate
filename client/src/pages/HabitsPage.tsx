...
const HABIT_COL_CLASS =
  'sticky left-0 z-20 w-[160px] max-w-[160px] border-r border-border bg-surface px-2'
...
export default function HabitsPage() {
  ...
  return (
    <div className="flex h-[calc(100dvh-5.25rem)] max-h-[calc(100dvh-5.25rem)] flex-col gap-1 overflow-hidden text-sm">
      ...
      {token && (
        <header className="flex shrink-0 flex-wrap items-center gap-x-3 gap-y-2 rounded-2xl border border-border bg-surface px-4 py-3">
          <div
          ...
          <div className="hidden h-5 w-px bg-[#2a2a33] sm:block" aria-hidden />
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs">
            ...
            <div className="flex min-w-[8rem] items-center gap-2">
              ...
              <div
                className="h-2 min-w-[5rem] flex-1 overflow-hidden rounded-full bg-[#07070a]"
              >
                <div
      ...
      {token && loading && (
        <div className="grid min-h-0 flex-1 grid-cols-[1fr_200px] gap-2">
          <Skeleton className="rounded-lg border border-[#2a2a33]" style={{ backgroundColor: '#111116' }} />
          <Skeleton className="rounded-lg border border-[#2a2a33]" style={{ backgroundColor: '#111116' }} />
        </div>
      )}
      ...
      {token && !loading && habits.length > 0 && (
        <div className="grid min-h-0 flex-1 grid-cols-1 gap-1 lg:grid-cols-[minmax(0,1fr)_200px]">
          <div className="flex min-h-0 min-w-0 flex-col gap-1">
                  ...
                  <tr>
                    ...
                    {weekBandSpans.map((band) => (
                      <th
                        ...
                        scope="colgroup"
                        className="h-6 border-b border-[#2a2a33] px-0 text-center text-[10px] font-semibold leading-6 text-white"
                            ...
                            <button
                              ...
                              style={
                                  ...
                                  : {
                                      ...
                                      borderColor: isFuture ? '#2a2a33' : incompleteBorder,
                                    }
                              }
            ...
            <div className="h-[160px] max-h-[160px] shrink-0 rounded-2xl border border-border bg-surface p-3">
                  ...
                  <AreaChart data={chartData} margin={{ top: 4, right: 4, left: -16, bottom: 0 }}>
                    <defs>
                      <linearGradient id="habitFill" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="#3dd6b0" stopOpacity={0.45} />
                        <stop offset="100%" stopColor="#3dd6b0" stopOpacity={0} />
                      </linearGradient>
                    </defs>
          ...
          <aside className="flex min-h-0 flex-col overflow-hidden rounded-2xl border border-border bg-surface p-3 lg:max-h-none">
            ...
            <ul className="mt-2 min-h-0 flex-1 space-y-2 overflow-y-auto pr-0.5">
              {habitAnalysis.map(({ habit: h, pct }) => (
                <li key={h.id}>
                  ...
                  <div className="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-[#07070a]">
                    <div
...
function Stat({ label, value, accent }: { label: string; value: string; accent?: boolean }) {
  return (
    <div className="flex items-baseline gap-1.5 whitespace-nowrap">
      ...
      <span className={accent ? 'font-bold tabular-nums text-[#3dd6b0]' : 'font-bold tabular-nums text-text-primary'}>
        {value}
      </span>
    </div>
  )
...
function StatsRow({
  ...
  return (
    <tr className="border-t border-[#2a2a33]/80 bg-[#07070a]/40">
