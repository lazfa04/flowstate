...
const WEEK_BAR_COLORS = ['#8b85ff', '#5cb8ff', '#3dd6b0', '#ff6b9d', '#f0b429'] as const
...
export function MindsetChartsPanel({ monthLogs, rangeLogs, year, month, loading }: Props) {
  ...
  if (loading) {
    return (
      <div className="flex h-full min-h-0 gap-2">
        <Skeleton className="min-h-0 w-[55%] rounded-2xl border border-border" />
        <Skeleton className="min-h-0 w-[45%] rounded-2xl border border-border" />
      </div>
    )
  }
  ...
  return (
    <div className="flex h-full min-h-0 min-w-0 gap-2">
      <div className="flex min-h-0 w-[55%] min-w-0 flex-col rounded-2xl border border-border p-3" style={{ backgroundColor: CHART_BG }}>
      ...
      <div className="flex min-h-0 w-[45%] min-w-0 flex-col rounded-2xl border border-border p-3" style={{ backgroundColor: CHART_BG }}>
