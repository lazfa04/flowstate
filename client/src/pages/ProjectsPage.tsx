    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <button
          ...
          onClick={openModal}
          disabled={!token}
          className="inline-flex items-center gap-2 rounded-xl bg-accent1 px-4 py-2.5 text-sm font-semibold text-background shadow-[0_0_24px_-8px_rgba(139,133,255,0.8)] transition hover:bg-accent1/90 disabled:cursor-not-allowed disabled:opacity-50"
        >
          + New Project
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
        {projects.map((p) => {
          ...
          return (
            <article
              key={p.id}
              className="flex flex-col overflow-hidden rounded-2xl border border-border bg-surface shadow-card transition hover:-translate-y-0.5 hover:border-accent1/30"
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-4 flex flex-wrap items-center justify-between gap-2">
                  ...
                  <Link
                    to={`/projects/${p.id}`}
                    className="inline-flex rounded-xl border border-border bg-background px-3 py-1.5 text-sm font-medium text-accent1 transition hover:bg-accent1/10"
                  >
                    Open
                  </Link>
                </div>
